...
class Brand (models.Model):    
    ...
    created_at= models.DateTimeField(auto_add_now=True,verbose_name=_("create_time"))
    created_at= models.DateTimeField(auto_add=True,verbose_name=_("modified_time"))
